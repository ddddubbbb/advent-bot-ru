...
Бот подключится к Telegram, и можно тестировать все сценарии прямо из чата.
...
- работу `Storage` (дети, задания, статусы);
- корректность reroll’а и календаря;
- статистику по детям;
- логику выбора заданий (не повторяет уже выданные);
- поведение Новогоднего магазина и клавиатур.
